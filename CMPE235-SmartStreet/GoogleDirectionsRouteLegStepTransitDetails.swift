//
//  GoogleDirectionsRouteLegStepTransitDetails.swift
//  GoogleDirections
//
...
/// Transit directions return additional information that is not relevant for other modes of transportation. From a `GoogleDirectionsRouteLegStepTransitDetails` object it is possible to access additional information about the transit stop, transit line and transit agency.
public struct GoogleDirectionsRouteLegStepTransitDetails {
	/// Information about the starting station for this part of the trip
	public var arrivalStop: GoogleDirectionsStop?
	/// Information about the stop station for this part of the trip
	public var departureStop: GoogleDirectionsStop?
	...
	public var line: GoogleDirectionsTransitLine?
}
