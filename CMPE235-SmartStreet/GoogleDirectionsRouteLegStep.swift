//
//  GoogleDirectionsRouteLegStep.swift
//  GoogleDirections
//
...
public class GoogleDirectionsRouteLegStep: NSObject, GoogleDirectionsSteppable {
	...
	public var travelMode: GoogleDirectionsMode?
	/// Transit-specific information (only returned with transit mode directions)
	public var transitDetails: GoogleDirectionsRouteLegStepTransitDetails?
