...
public enum GoogleDirectionsError: Int {
	...
	/**
	Returns an `GoogleDirectionsError` object corresponding to the status code returned by the API for a specific response.
	
	- parameter status: The status code returned by the API
	- returns: The corresponding `GoogleDirectionsError` instance
	*/
	static func errorFromStatus(status: String) -> GoogleDirectionsError {
		switch (status) {
		case "OK":
			return .OK
		case "NOT_FOUND":
...
public enum GoogleDirectionsMode: Int {
	...
	/**
	Returns an `GoogleDirectionsMode` object corresponding to the status code returned by the API for a specific response.
	
	- parameter label: The label returned by the API
	- returns: The corresponding `GoogleDirectionsMode` instance, or `nil` if no appropriate mode is found
	*/
	public static func modeFromLabel(label: String) -> GoogleDirectionsMode? {
		switch label {
		case "DRIVING":
			return .Driving
		case "WALKING":
...
extension GoogleDirectionsMode: CustomStringConvertible {
	public var description: String {
		switch self {
		case .Driving:
			return "driving"
...
public enum GoogleDirectionsFeature: Int {
...
extension GoogleDirectionsFeature: CustomStringConvertible {
	public var description: String {
		switch self {
		case .Tolls:
			return "tolls"
...
public enum GoogleDirectionsUnit: Int {
...
extension GoogleDirectionsUnit: CustomStringConvertible {
	public var description: String {
		switch self {
		case .Metric:
			return "metric"
...
public enum GoogleDirectionsTransitMode: Int {
...
extension GoogleDirectionsTransitMode: CustomStringConvertible {
	public var description: String {
		switch self {
		case .Bus:
			return "bus"
...
public enum GoogleDirectionsTransitRoutingPreference: Int {
...
extension GoogleDirectionsTransitRoutingPreference: CustomStringConvertible {
	public var description: String {
		switch self {
		case .LessWalking:
			return "less_walking"
...
public enum GoogleDirectionsVehicleType: Int {
	/// Rail
	case Rail = 0
	/// Light rail transit
	case MetroRail
	...
	/**
	Returns an `GoogleDirectionsVehicleType` object corresponding to the vehicle type returned by the API for a specific line.
	
	- parameter value: The vehicle type code returned by the API
	- returns: The corresponding `GoogleDirectionsVehicleType` instance
	*/
	public static func vehicleTypeFromValue(value: String) -> GoogleDirectionsVehicleType {
		switch value {
		case "RAIL":
			return .Rail
		case "METRO_RAIL":
...
public enum GoogleMapsMode: Int {
	/// Standard map view
	case Standard = 0
...
extension GoogleMapsMode: CustomStringConvertible {
	public var description: String {
		switch self {
		case .Standard:
			return "standard"
...
public enum GoogleMapsView: Int {
...
extension GoogleMapsView: CustomStringConvertible {
	public var description: String {
		switch self {
		case .Satellite:
			return "satellite"
